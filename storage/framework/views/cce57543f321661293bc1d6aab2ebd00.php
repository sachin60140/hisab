            ...
            <div class="col-md-6 mx-auto">
                ...
                <div class="card">
                    <div class="card-body bg-danger bg-opacity-75">
                        ...
                        <!-- Multi Columns Form -->
                        <form class="row g-3" action="<?php echo e(route('payment')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="col-md-12">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\carac\resources\views/admin/payment.blade.php ENDPATH**/ ?>